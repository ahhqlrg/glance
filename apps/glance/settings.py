"""
Django settings for glance project.
...
MIDDLEWARE = [
    ...
    'glance.middleware.TimezoneMiddleware',
    'glance.middleware.DemoMiddleware',
    'glance.middleware.RequestMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'glance.context_processor.glance_processor',
...
# WSGI_APPLICATION = 'glance.wsgi.applications'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            "backupCount": 7,
            'formatter': 'main',
            'filename': os.path.join(PROJECT_DIR, 'logs', 'glance.log')
        },
        'ansible_logs': {
            'level': 'DEBUG',
...
SWAGGER_SETTINGS = {
    'DEFAULT_AUTO_SCHEMA_CLASS': 'glance.swagger.CustomSwaggerAutoSchema',
