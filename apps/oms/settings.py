...
MIDDLEWARE = [
    ...
    'oms.middleware.TimezoneMiddleware',
    'oms.middleware.DemoMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'oms.context_processor.jumpserver_processor',
...
# WSGI_APPLICATION = 'oms.wsgi.applications'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'main',
            'filename': os.path.join(PROJECT_DIR, 'logs', 'oms.log')
        },
        'ansible_logs': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
