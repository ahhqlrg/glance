...
class Config:
    ...
    # But we should know the absolute url like: http://jms.glance.org/login/, so SITE_URL is
    ...
    # Api token expiration when create, glance refresh time when request arrive
    ...
    EMAIL_SUBJECT_PREFIX = '[glance] '

    CAPTCHA_TEST_MODE = False

    # You can set glance usage url here, that when user submit wizard redirect to
    USER_GUIDE_URL = ''

    # LDAP Auth settings
    AUTH_LDAP = False
    AUTH_LDAP_SERVER_URI = 'ldap://localhost:389'
    AUTH_LDAP_BIND_DN = 'cn=admin,dc=glance,dc=org'
    AUTH_LDAP_BIND_PASSWORD = ''
    AUTH_LDAP_SEARCH_OU = 'ou=tech,dc=glance,dc=org'
...
class DockerConfig(Config):
    ...
    # SITE_URL = "http://glance.fit2cloud.com"
    ...
    # 数据库密码
    # DB_PASSWORD = "db_glance_password"
    ...
    EMAIL_PORT = 25
    # SMTP连接邮箱地址
    # EMAIL_HOST_USER = "noreply@glance.org"
    EMAIL_HOST_USER = ''
